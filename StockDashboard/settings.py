...
INSTALLED_APPS = [
    ...
    'main', #controls other apps for this project
    'listItems',
    'stocks',
    'channels',
]
...
ASGI_APPLICATION = 'StockDashboard.asgi.application'
CHANNEL_LAYERS = {
    'default': {
...
DATABASES = {
    ...
    # }
    'default': dj_database_url.config(default='sqlite:////db.sqlite3') #can also work in local
}
